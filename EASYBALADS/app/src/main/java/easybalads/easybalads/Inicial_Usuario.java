...
public class Inicial_Usuario extends AppCompatActivity
    ...
    public void clickCadEvento(View v){
        final EditText titulo,data,hora,descricao,cep,end,bairro,cidade,estado,valor;
        ...
        if(titulo.getText().toString().equals("")) {
            ...
            dialog.show();
                String cod = end.getText().toString() + "," + bairro.getText().toString() + "," + cidade.getText().toString() + "," + estado.getText().toString();
            ...
            handle.postDelayed(new Runnable() {
                ...
                mDatabaseUser.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        novoEvento.child("titulo").setValue(titulo.getText().toString());
                        novoEvento.child("data").setValue(data.getText().toString());
                        novoEvento.child("hora").setValue(hora.getText().toString());
                        novoEvento.child("descricao").setValue(descricao.getText().toString());
                        novoEvento.child("cep").setValue(cep.getText().toString());
                        novoEvento.child("endereco").setValue(end.getText().toString());
                        novoEvento.child("bairro").setValue(bairro.getText().toString());
                        novoEvento.child("cidade").setValue(cidade.getText().toString());
                        novoEvento.child("estado").setValue(estado.getText().toString());
                        novoEvento.child("valor").setValue(valor.getText().toString());
                        novoEvento.child("latitude").setValue(lat);
                        novoEvento.child("longitude").setValue(lng);
                        novoEvento.child("participantes").setValue(0);
                        novoEvento.child("organizador").setValue(razao.toString().trim());
